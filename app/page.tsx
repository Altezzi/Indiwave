    ...
    <div>
      ...
      <div style={{ textAlign: "center", marginBottom: "40px", padding: "40px 20px" }}>
        ...
        <p style={{ margin: "0 0 24px", fontSize: "18px", color: "var(--fg)", maxWidth: "600px", margin: "0 auto 24px" }}>
          Discover amazing comics from independent creators and public domain classics. 
          Your gateway to unique stories and artistic adventures.
        </p>
        <div style={{ display: "flex", gap: "16px", justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <Link href="/create-account" style={{ 
            padding: "12px 24px", 
      ...
      <div style={{ 
        ...
        <div style={{ marginBottom: "24px" }}>
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ color: "var(--accent)", margin: "0 auto 16px" }}>
            <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/>
          </svg>
          <h2 style={{ margin: "0 0 12px", fontSize: "24px", fontWeight: "600", color: "var(--fg)" }}>
            Add Indiwave to Your Device
          </h2>
          <p style={{ margin: "0 0 24px", fontSize: "16px", color: "var(--muted)", maxWidth: "500px", margin: "0 auto 24px" }}>
            Get quick access to Indiwave by adding it to your home screen or bookmarks
          </p>
        </div>
        ...
        <div style={{ 
          ...
          <div style={{
            ...
            <div style={{ fontSize: "14px", color: "var(--muted)", lineHeight: "1.6" }}>
              <p style={{ margin: "0 0 8px", fontWeight: "500", color: "var(--fg)" }}>iOS (Safari):</p>
              <p style={{ margin: "0 0 12px" }}>Tap Share → Add to Home Screen</p>
              
              <p style={{ margin: "0 0 8px", fontWeight: "500", color: "var(--fg)" }}>Android (Chrome):</p>
          ...
          <div style={{
            ...
            <div style={{ fontSize: "14px", color: "var(--muted)", lineHeight: "1.6" }}>
              <p style={{ margin: "0 0 8px", fontWeight: "500", color: "var(--fg)" }}>Desktop Shortcut:</p>
              <p style={{ margin: "0 0 12px" }}>Right-click desktop → Create Shortcut → Enter URL</p>
              
              <p style={{ margin: "0 0 8px", fontWeight: "500", color: "var(--fg)" }}>Browser Bookmark:</p>
