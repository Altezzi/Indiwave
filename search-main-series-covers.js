// Try to get covers by searching for the main series names
const fs = require('fs');
const path = require('path');

// Map of series without covers to their main series names for searching
const seriesMapping = [
  { folder: "Metal Gear Solid", search: "Metal Gear Solid" },
  { folder: "Bayonetta", search: "Bayonetta" },
  { folder: "Demon Slayer Rengoku", search: "Demon Slayer" },
  { folder: "Naruto Sakura's Story", search: "Naruto" },
  { folder: "Tokyo Ghoul Joker", search: "Tokyo Ghoul" },
  { folder: "Vinland Saga Slave Arc", search: "Vinland Saga" },
  { folder: "Dragon Ball The Path to Power", search: "Dragon Ball" },
  { folder: "Dragon Ball Z Battle of Gods", search: "Dragon Ball Z" },
  { folder: "Fullmetal Alchemist The Conqueror of Shamballa", search: "Fullmetal Alchemist" },
  { folder: "Fullmetal Alchemist The Sacred Star of Milos", search: "Fullmetal Alchemist" },
  { folder: "Fullmetal Alchemist The Promise Day", search: "Fullmetal Alchemist" },
  { folder: "Fullmetal Alchemist The First Attack", search: "Fullmetal Alchemist" },
  { folder: "Fullmetal Alchemist The Ties That Bind", search: "Fullmetal Alchemist" },
  { folder: "Bleach Can't Fear Your Own World", search: "Bleach" },
  { folder: "Bleach DiamondDust Rebellion", search: "Bleach" },
  { folder: "Bleach We Do Knot Always Love You", search: "Bleach" },
  { folder: "One Piece Film Gold", search: "One Piece" },
  { folder: "One Piece Red", search: "One Piece" },
  { folder: "One Piece Stampede", search: "One Piece" },
  { folder: "One Punch Man Road to Hero", search: "One Punch Man" },
  { folder: "Hunter x Hunter Kurapika's Memories", search: "Hunter x Hunter" }
];
...
async function updateMissingCovers() {
  for (const { folder: seriesName, search: searchTerm } of seriesMapping) {
    try {
