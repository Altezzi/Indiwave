...
// Comprehensive script to import even more manga
// This will search for manga from multiple categories and import them
...
// Even more comprehensive list of manga to search for
const mangaToSearch = [
  // More Popular Shonen
  'Boruto',
  'Black Clover',
...
async function searchAndImportManga() {
  ...
  console.log('Searching for new manga to import...');
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.data && data.data.length > 0) {
          ...
          if (newMangaToImport.length >= 100) {
            console.log('Reached limit of 100 new manga to import');
            break;
          }
        } else {
